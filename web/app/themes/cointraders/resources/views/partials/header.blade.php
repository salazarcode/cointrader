...
<nav class="navbar is-spaced is-full-width " data-aos="" data-start="top 10%" role="navigation">
  <div class="container">
    <div class="navbar-brand">
      <a  style="background-color:#10212B; pointer-events: auto;heigh"class="level-item has-margin-right-20 has-padding-5 has-background-dark" href="{{home_url()}}">

        <img src="{{home_url('/app/uploads/2021/06/Logo-Intradrer-white.png')}}" width="200">
      </a>
