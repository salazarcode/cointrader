...
<nav class="navbar is-spaced is-full-width " data-aos="" data-start="top 10%" role="navigation">
  <div class="container">
    <div class="navbar-brand">
      <a  style="background-color:#10212B; pointer-events: auto;heigh"class="level-item has-margin-right-20 has-padding-5 has-background-dark" href="<?php echo e(home_url()); ?>">

        <img src="<?php echo e(home_url('/app/uploads/2021/06/Logo-Intradrer-white.png')); ?>" width="200">
      </a>
      ...
      <div class="navbar-end">
        <div class="navbar-item">
          <div class="buttons is-flex align-items-center">
            <a style="pointer-events: auto;" class="button is-outlined">
              CONTÁCTANOS
            </a>
...
</div><?php /**PATH C:\laragon\www\cointrader\web\app\themes\cointraders\resources\views/partials/header.blade.php ENDPATH**/ ?>